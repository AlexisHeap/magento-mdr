...
namespace Cimaco\Minerva\Controller\Adminhtml\Faq;

use Cimaco\Minerva\Model\Faq;
use Cimaco\Minerva\Model\FaqFactory;
use Cimaco\Minerva\Model\ResourceModel\Faq as FaqResource;
...
{
    const ADMIN_RESOURCE = 'Cimaco_Minerva::faq_delete';
